...
#define SERVICE_UUID "8FBB11A7-163B-43C8-9D4F-FCA02297A258"
...
void setup() {
    Serial.begin(115200);
    BLEDevice::init("Heater");                        // Initialize the BLE device.
...
void loop() {
  ...
  String message_to_sent = "Hey, I am a heater, my timestamp" + String(currentMillis); // Message to be sent to the main controller.
