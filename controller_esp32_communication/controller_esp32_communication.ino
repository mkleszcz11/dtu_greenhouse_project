...
uint8_t sensor_info[] = {27, 60, 30}; // set for testing
...
void loop() {
  ...
  lora_transmit(sensor_info, 2);
  lora_receive(control_info, 2); // control_info not being the correct size could cause segmentation fault
